    ...
    <div class="container d-flex flex-column justify-content-center align-items-center w-100 h-75">
        ...
        <div class="container d-flex justify-content-center">
            <form action="../../controllers/authentication/login.php" method="post">
                ...
                <div>
                    <input type="email" class="form-control bg-body-tertiary input" name="email" id="email"
                        placeholder="E-mail" required />
                </div>
                <div class="mt-3">
                    <input type="password" class="form-control bg-body-tertiary input" name="password" id="password"

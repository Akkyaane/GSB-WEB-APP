...
<body>
    ...
    <main>
        ...
        <form
            action="../../../controllers/functionalities/ExpenseSheet/ProcessExpenseSheet.php?processid=<?php echo $data['expense_sheet_id']; ?>"
            method="post">
            <div class="mt-3">
                <h5>Détails du refus</h5>
                <div class="mt-3">
                    <textarea class="form-control" rows="3" name="remark" id="remark"
                        placeholder="Écrire une remarque..." maxlength="500"></textarea>

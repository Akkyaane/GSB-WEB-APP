...
<head>
    ...
    <title>GSB - Traiter fiche de frais</title>
...
<body>
    ...
    <main>
        <div class="container p-3">
            ...
            <form
                action="../../../controllers/functionalities/ExpenseSheet/ProcessExpenseSheet.php?processid=<?php echo $_GET['id'] ?>"
                method="post">
                <div class="my-3">
                    <h3 class="mb-1 fs-5 fw-semibold">Traitement</h3>
                    <div class="my-3">
                        <label class="mb-2">Motif du rejet :</label>
                        <textarea class="form-control input" rows="3" name="remark" id="remark"
                            placeholder="Écrire un message..." maxlength="500"></textarea>
                        <div id="charCount">0/500</div>
                    </div>
                    <div class="my-3">
                        <button type="submit" class="btn btn-primary c-link" name="validate_submit"
                            id="submit">Valider</button>
                        <button type="submit" class="btn btn-primary c-link" name="disprove_submit"
                            id="submit">Refuser</button>
                        <a class="btn btn-primary c-link"
                            href="../../../controllers/portals/accountant">Retour</a></button>
                    </div>
                </div>
            </form>
        </div>

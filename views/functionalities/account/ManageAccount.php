...
<body>
    ...
    <main>
        <div class="container p-2">
            <h2 class="mb-3 ps-2 fs-4 fw-bold">Mes informations</h2>
            ...
            <div class="d-flex gap-1">
                <div>
                    ...
                    if ($_SESSION['id'] == $data['user_id']) {
                        echo "<a class='btn btn-primary c-link' href='../../../controllers/functionalities/account/UpdateAccount.php'>Modifier</a>";
                    }
                    ?>
                </div>
                <div>

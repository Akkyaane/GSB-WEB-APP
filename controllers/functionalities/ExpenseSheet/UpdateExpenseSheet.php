...
if (isset($_GET['updateid'])) {
        ...
        if ($expense_sheet[":tc"] != 4) {
            if (!empty($_POST["transport_expense"])) {
                ...
                if (!empty($_FILES["transport_expense_file"]["name"])) {
                    ...
                    header("Location: UpdateExpenseSheet?updateid=" . $_GET['updateid']);
                }
            ...
            if (!empty($_POST["kilometers_number"])) {
                ...
                header("Location: UpdateExpenseSheet?id=" . $_GET['updateid']);
            }
        }
    } else {
    ...
    if ($uploadOk == NULL || $uploadOk != FALSE) {
        ...
        header("Location: ../../portals/visitor.php?manageExpenseSheet&id=" . $_GET['updateid']);
    }
}
